...
import AttendanceReportsModule from '../AttendanceReportsModule.tsx';
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 md:p-6 space-y-6">
      ...
      <div>
        ...
        {activeTab === 'reports' && (
          <AttendanceReportsModule students={allStudentsList.length > 0 ? allStudentsList : INITIAL_STUDENTS} />
        )}
